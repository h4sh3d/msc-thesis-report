...
% Chapters
\setcounter{mtc}{3} % Help minitoc skip the front matter chapters
\include{02-main/ch1_introduction}
\include{02-main/ch2_bitcoin}
\include{02-main/ch3_payment_channel}
\include{02-main/ch4_threshold}
\include{02-main/ch5_implementation}
\include{02-main/ch6_further_research}
...
\thispagestyle{empty}
\cleardoublepage
\includepdf[pages=-]{03-tail/appendix/btc-channel.pdf}
