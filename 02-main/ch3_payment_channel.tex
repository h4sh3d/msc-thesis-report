...
This table summarize the different properties following the proposed definitions
...
Network and \say{Yours Lightning Protocol} \cite{poon2016bitcoin, YoursLightningProtocol}.
