...
The parser takes in input an array of bytes with a length and the private key to
...
The function implementation can also be splited in four main parts (i) generate
