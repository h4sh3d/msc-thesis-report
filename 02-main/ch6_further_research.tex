...
In the paper \say{Efficient Identification and Signatures for Smart Cards} published
in CRYPTO 1989, C.P. Schnorr propose the \say{Schnorr signature algorithm}
