...
% Securing bitcoin with two Hardware wallet
% - how to integrate threshold HDWallet
% - import/export and visualization of threshold keys
% - integrate the master share tag in the DER key format or not ?
