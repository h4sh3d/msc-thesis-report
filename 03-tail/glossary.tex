...
{
	name={Levee},
	description={Levee est une implémentation des concepts de protection CPI/CPS et SafeStack. Actuellement, mai 2017, une partie du projet a été intégré au sein de LLVM sous le nom de Safe Stack}
}
